...
<h1>Lector de qr</h1>    <div id="reader"> <!-- ESCÁNER DE QR --> </div>
      <div id="contenedorTexto">
        <h3>¿Que puedo hacer con la app?</h3>
        <h4>Escanear el Qr de un muro e interactua con el
        </h4>
        <h4>Crear tu propio muro y compartirlo con quien quieras
        </h4>
